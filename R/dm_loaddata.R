...
ppi_hint <- read.csv("c:\\common_laptop\\R-files\\proteins\\HINT-2018.csv", header=TRUE,stringsAsFactors = FALSE)
...
disgene <- file.path('C://common_laptop//R-files//DiseaseModules//','gene_disease_associations.tsv') %>% read.delim(na.strings='',sep='\t',header=TRUE,comment.char="#")
...
indications  <- file.path('C://common_laptop//R-files//sider', 'indications.tsv') %>% read.delim(na.strings='',header = TRUE,stringsAsFactors=FALSE)
names(indications)[names(indications)=="umls_cui_from_label"] <- "umls"
indications <- indications[,c(1:2,5,7,9,10)]

meshtree <- file.path('C://common_laptop//R-files//disease//','meshtreefull.csv') %>% read.delim(na.strings='',sep=',',header=TRUE,comment.char="#")
...
mappings <- file.path('C://common_laptop//R-files//disease//','map_umls_2_mesh.tsv') %>% read.delim(na.strings='',sep='\t',header=TRUE,comment.char="#")
